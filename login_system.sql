...
--
-- Host: localhost
-- Generation Time: Jul 04, 2023 at 07:58 PM
...
--
ALTER TABLE `chapters`
  ADD CONSTRAINT `chapter_to_subject_id_fk` FOREIGN KEY (`sub_id`) REFERENCES `subjects` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `chapter_relation`
--
ALTER TABLE `chapter_relation`
  ADD CONSTRAINT `chapter_id_to_chapter_id_fk` FOREIGN KEY (`chapter_id`) REFERENCES `chapters` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `sub_id_to_subjects_id_fk` FOREIGN KEY (`sub_id`) REFERENCES `subjects` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `student_relation`
--
ALTER TABLE `student_relation`
  ADD CONSTRAINT `student_id_to_info_id_fk` FOREIGN KEY (`student_id`) REFERENCES `info` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `student_relation_ibfk_1` FOREIGN KEY (`std_id`) REFERENCES `standards` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `subject_relation`
--
ALTER TABLE `subject_relation`
  ADD CONSTRAINT `std_id_to_std_id_fk` FOREIGN KEY (`std_id`) REFERENCES `standards` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `sub_id_to_sub_id_fk` FOREIGN KEY (`sub_id`) REFERENCES `subjects` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `usertype`
--
ALTER TABLE `usertype`
  ADD CONSTRAINT `user_id_to_info_id` FOREIGN KEY (`user_id`) REFERENCES `info` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `user_type_to_access_type_id_fk` FOREIGN KEY (`user_type`) REFERENCES `accesstype` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
