        ...
        <div class="body">
            <div class="sidebar">
                ...
                <div class="dropdown-container">
                    ...
                    ?>
                        <a href="assign_subject">Assign Subjects</a>
                    <?php
                    }
                    ?>
                    <?php
            ...
            <div class="main_container">
                <div class="inside_main_container">
                    ...
                    ?>
                        <form action="chapters.php" method="post" name="add_chapter_form" class="add_form">
                    ...
                    if (isset($_POST['add'])) {
                        ...
                        $chapter_insert = "INSERT INTO `chapters` (`chapter`) VALUES ('$chapter_input')";
                    ...
                    ?>
                        <form action="" method="post" name="update_chapter_form" class="update_sub_form add_form">
